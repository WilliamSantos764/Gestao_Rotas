...
## V5.35 — embarque automático por rota
...
## V5.35 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.35 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.35 **não move pedidos automaticamente** entre embarques.
...
## V5.35 — mapa semanal e antecipação de rotas futuras
...
## V5.35 — leite, derivados e filtros de alocação

A V5.35 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.35 — regras selecionáveis de alocação
...
## V5.35 — recálculo automático ao mudar as regras
...
## V5.35 — mapeamento automático de colunas
...
## V5.35 — identificação de planilha otimizada
...
## V5.35 — correção do travamento em “Identificando estrutura”
...
## V5.35 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.35.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.35 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.35 — leitor Excel robusto com fallback direto
...
## V5.35 — correção de `parseSharedBytes is not defined`
...
## V5.35 — suporte a XML com namespace/prefixo
...
A V5.35 reconhece os dois formatos.
...
## V5.35 — cálculo do peso por pedido e alocação por capacidade
...
## V5.35 — leite puro somente manual
...
## V5.35 — roteirização porta a porta por embarque
...
## V5.35 — rotas de entrega por motorista na Análise inteligente
...
## V5.35 — perto para longe + App do Motorista
...
## V5.35 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.35 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.35 — um único App com todas as entregas do motorista
...
- links V5.35 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.35 — GPS do motorista + monitoramento em tempo real
...
## V5.35 — Firebase já integrado ao software
...
## Correção V5.35 — link do App do Motorista
...
## V5.35 — traçado da rota no mapa do motorista
...
`V5.35 — traçado rodoviário`

## V5.35 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.35 — canhoto obrigatório e WhatsApp
...
## V5.35 — correção do travamento do canhoto
...
A V5.35 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
...
## V5.35 — finalização das rotas e canhotos na central
