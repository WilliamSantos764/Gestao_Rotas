...
## V5.33 — embarque automático por rota
...
## V5.33 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.33 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.33 **não move pedidos automaticamente** entre embarques.
...
## V5.33 — mapa semanal e antecipação de rotas futuras
...
## V5.33 — leite, derivados e filtros de alocação

A V5.33 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.33 — regras selecionáveis de alocação
...
## V5.33 — recálculo automático ao mudar as regras
...
## V5.33 — mapeamento automático de colunas
...
## V5.33 — identificação de planilha otimizada
...
## V5.33 — correção do travamento em “Identificando estrutura”
...
## V5.33 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.33.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.33 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.33 — leitor Excel robusto com fallback direto
...
## V5.33 — correção de `parseSharedBytes is not defined`
...
## V5.33 — suporte a XML com namespace/prefixo
...
A V5.33 reconhece os dois formatos.
...
## V5.33 — cálculo do peso por pedido e alocação por capacidade
...
## V5.33 — leite puro somente manual
...
## V5.33 — roteirização porta a porta por embarque
...
## V5.33 — rotas de entrega por motorista na Análise inteligente
...
## V5.33 — perto para longe + App do Motorista
...
## V5.33 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.33 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.33 — um único App com todas as entregas do motorista
...
- links V5.33 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.33 — GPS do motorista + monitoramento em tempo real
...
## V5.33 — Firebase já integrado ao software
...
## Correção V5.33 — link do App do Motorista
...
## V5.33 — traçado da rota no mapa do motorista
...
`V5.33 — traçado rodoviário`

## V5.33 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.33 — canhoto obrigatório e WhatsApp
