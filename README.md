...
## V5.34 — embarque automático por rota
...
## V5.34 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.34 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.34 **não move pedidos automaticamente** entre embarques.
...
## V5.34 — mapa semanal e antecipação de rotas futuras
...
## V5.34 — leite, derivados e filtros de alocação

A V5.34 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.34 — regras selecionáveis de alocação
...
## V5.34 — recálculo automático ao mudar as regras
...
## V5.34 — mapeamento automático de colunas
...
## V5.34 — identificação de planilha otimizada
...
## V5.34 — correção do travamento em “Identificando estrutura”
...
## V5.34 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.34.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.34 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.34 — leitor Excel robusto com fallback direto
...
## V5.34 — correção de `parseSharedBytes is not defined`
...
## V5.34 — suporte a XML com namespace/prefixo
...
A V5.34 reconhece os dois formatos.
...
## V5.34 — cálculo do peso por pedido e alocação por capacidade
...
## V5.34 — leite puro somente manual
...
## V5.34 — roteirização porta a porta por embarque
...
## V5.34 — rotas de entrega por motorista na Análise inteligente
...
## V5.34 — perto para longe + App do Motorista
...
## V5.34 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.34 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.34 — um único App com todas as entregas do motorista
...
- links V5.34 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.34 — GPS do motorista + monitoramento em tempo real
...
## V5.34 — Firebase já integrado ao software
...
## Correção V5.34 — link do App do Motorista
...
## V5.34 — traçado da rota no mapa do motorista
...
`V5.34 — traçado rodoviário`

## V5.34 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.34 — canhoto obrigatório e WhatsApp
...
## V5.34 — correção do travamento do canhoto
...
A V5.34 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
