...
## V5.36 — embarque automático por rota
...
## V5.36 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.36 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.36 **não move pedidos automaticamente** entre embarques.
...
## V5.36 — mapa semanal e antecipação de rotas futuras
...
## V5.36 — leite, derivados e filtros de alocação

A V5.36 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.36 — regras selecionáveis de alocação
...
## V5.36 — recálculo automático ao mudar as regras
...
## V5.36 — mapeamento automático de colunas
...
## V5.36 — identificação de planilha otimizada
...
## V5.36 — correção do travamento em “Identificando estrutura”
...
## V5.36 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.36.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.36 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.36 — leitor Excel robusto com fallback direto
...
## V5.36 — correção de `parseSharedBytes is not defined`
...
## V5.36 — suporte a XML com namespace/prefixo
...
A V5.36 reconhece os dois formatos.
...
## V5.36 — cálculo do peso por pedido e alocação por capacidade
...
## V5.36 — leite puro somente manual
...
## V5.36 — roteirização porta a porta por embarque
...
## V5.36 — rotas de entrega por motorista na Análise inteligente
...
## V5.36 — perto para longe + App do Motorista
...
## V5.36 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.36 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.36 — um único App com todas as entregas do motorista
...
- links V5.36 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.36 — GPS do motorista + monitoramento em tempo real
...
## V5.36 — Firebase já integrado ao software
...
## Correção V5.36 — link do App do Motorista
...
## V5.36 — traçado da rota no mapa do motorista
...
`V5.36 — traçado rodoviário`

## V5.36 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.36 — canhoto obrigatório e WhatsApp
...
## V5.36 — correção do travamento do canhoto
...
A V5.36 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
...
## V5.36 — finalização das rotas e canhotos na central
...
## V5.36 — rotas pendentes e concluídas separadas
