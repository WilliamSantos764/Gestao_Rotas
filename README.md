...
## V5.43 — embarque automático por rota
...
## V5.43 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.43 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.43 **não move pedidos automaticamente** entre embarques.
...
## V5.43 — mapa semanal e antecipação de rotas futuras
...
## V5.43 — leite, derivados e filtros de alocação

A V5.43 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.43 — regras selecionáveis de alocação
...
## V5.43 — recálculo automático ao mudar as regras
...
## V5.43 — mapeamento automático de colunas
...
## V5.43 — identificação de planilha otimizada
...
## V5.43 — correção do travamento em “Identificando estrutura”
...
## V5.43 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.43.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.43 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.43 — leitor Excel robusto com fallback direto
...
## V5.43 — correção de `parseSharedBytes is not defined`
...
## V5.43 — suporte a XML com namespace/prefixo
...
A V5.43 reconhece os dois formatos.
...
## V5.43 — cálculo do peso por pedido e alocação por capacidade
...
## V5.43 — leite puro somente manual
...
## V5.43 — roteirização porta a porta por embarque
...
## V5.43 — rotas de entrega por motorista na Análise inteligente
...
## V5.43 — perto para longe + App do Motorista
...
## V5.43 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.43 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.43 — um único App com todas as entregas do motorista
...
- links V5.43 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.43 — GPS do motorista + monitoramento em tempo real
...
## V5.43 — Firebase já integrado ao software
...
## Correção V5.43 — link do App do Motorista
...
## V5.43 — traçado da rota no mapa do motorista
...
`V5.43 — traçado rodoviário`

## V5.43 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.43 — canhoto obrigatório e WhatsApp
...
## V5.43 — correção do travamento do canhoto
...
A V5.43 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
...
## V5.43 — finalização das rotas e canhotos na central
...
## V5.43 — rotas pendentes e concluídas separadas
...
## V5.43 — gerar somente rotas pendentes + exceções do motorista
...
## V5.43 — ESPD fonte mestre + reentregas
...
## V5.43 — roteirização de teste com coordenadas fixas

Para eliminar falhas de geocodificação durante testes, a V5.43 reconhece duas novas colunas opcionais:
...
## V5.43 — descarga na frente do estabelecimento / otimização por rua
...
## V5.43 — Embarques e Central de Rotas reorganizados
...
## V5.43 — correção da linha azul no App do Motorista
...
## V5.43 — Central de Rotas compacta
