...
## V5.42 — embarque automático por rota
...
## V5.42 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.42 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.42 **não move pedidos automaticamente** entre embarques.
...
## V5.42 — mapa semanal e antecipação de rotas futuras
...
## V5.42 — leite, derivados e filtros de alocação

A V5.42 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.42 — regras selecionáveis de alocação
...
## V5.42 — recálculo automático ao mudar as regras
...
## V5.42 — mapeamento automático de colunas
...
## V5.42 — identificação de planilha otimizada
...
## V5.42 — correção do travamento em “Identificando estrutura”
...
## V5.42 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.42.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.42 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.42 — leitor Excel robusto com fallback direto
...
## V5.42 — correção de `parseSharedBytes is not defined`
...
## V5.42 — suporte a XML com namespace/prefixo
...
A V5.42 reconhece os dois formatos.
...
## V5.42 — cálculo do peso por pedido e alocação por capacidade
...
## V5.42 — leite puro somente manual
...
## V5.42 — roteirização porta a porta por embarque
...
## V5.42 — rotas de entrega por motorista na Análise inteligente
...
## V5.42 — perto para longe + App do Motorista
...
## V5.42 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.42 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.42 — um único App com todas as entregas do motorista
...
- links V5.42 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.42 — GPS do motorista + monitoramento em tempo real
...
## V5.42 — Firebase já integrado ao software
...
## Correção V5.42 — link do App do Motorista
...
## V5.42 — traçado da rota no mapa do motorista
...
`V5.42 — traçado rodoviário`

## V5.42 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.42 — canhoto obrigatório e WhatsApp
...
## V5.42 — correção do travamento do canhoto
...
A V5.42 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
...
## V5.42 — finalização das rotas e canhotos na central
...
## V5.42 — rotas pendentes e concluídas separadas
...
## V5.42 — gerar somente rotas pendentes + exceções do motorista
...
## V5.42 — ESPD fonte mestre + reentregas
...
## V5.42 — roteirização de teste com coordenadas fixas

Para eliminar falhas de geocodificação durante testes, a V5.42 reconhece duas novas colunas opcionais:
...
## V5.42 — descarga na frente do estabelecimento / otimização por rua
...
## V5.42 — Embarques e Central de Rotas reorganizados
...
## V5.42 — correção da linha azul no App do Motorista
