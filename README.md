...
## V5.39 — embarque automático por rota
...
## V5.39 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.39 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.39 **não move pedidos automaticamente** entre embarques.
...
## V5.39 — mapa semanal e antecipação de rotas futuras
...
## V5.39 — leite, derivados e filtros de alocação

A V5.39 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.39 — regras selecionáveis de alocação
...
## V5.39 — recálculo automático ao mudar as regras
...
## V5.39 — mapeamento automático de colunas
...
## V5.39 — identificação de planilha otimizada
...
## V5.39 — correção do travamento em “Identificando estrutura”
...
## V5.39 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.39.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.39 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.39 — leitor Excel robusto com fallback direto
...
## V5.39 — correção de `parseSharedBytes is not defined`
...
## V5.39 — suporte a XML com namespace/prefixo
...
A V5.39 reconhece os dois formatos.
...
## V5.39 — cálculo do peso por pedido e alocação por capacidade
...
## V5.39 — leite puro somente manual
...
## V5.39 — roteirização porta a porta por embarque
...
## V5.39 — rotas de entrega por motorista na Análise inteligente
...
## V5.39 — perto para longe + App do Motorista
...
## V5.39 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.39 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.39 — um único App com todas as entregas do motorista
...
- links V5.39 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.39 — GPS do motorista + monitoramento em tempo real
...
## V5.39 — Firebase já integrado ao software
...
## Correção V5.39 — link do App do Motorista
...
## V5.39 — traçado da rota no mapa do motorista
...
`V5.39 — traçado rodoviário`

## V5.39 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.39 — canhoto obrigatório e WhatsApp
...
## V5.39 — correção do travamento do canhoto
...
A V5.39 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
...
## V5.39 — finalização das rotas e canhotos na central
...
## V5.39 — rotas pendentes e concluídas separadas
...
## V5.39 — gerar somente rotas pendentes + exceções do motorista
...
## V5.39 — ESPD fonte mestre + reentregas
...
## V5.39 — roteirização de teste com coordenadas fixas

Para eliminar falhas de geocodificação durante testes, a V5.39 reconhece duas novas colunas opcionais:
