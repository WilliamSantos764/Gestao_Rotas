...
## V5.31 — embarque automático por rota
...
## V5.31 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.31 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.31 **não move pedidos automaticamente** entre embarques.
...
## V5.31 — mapa semanal e antecipação de rotas futuras
...
## V5.31 — leite, derivados e filtros de alocação

A V5.31 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.31 — regras selecionáveis de alocação
...
## V5.31 — recálculo automático ao mudar as regras
...
## V5.31 — mapeamento automático de colunas
...
## V5.31 — identificação de planilha otimizada
...
## V5.31 — correção do travamento em “Identificando estrutura”
...
## V5.31 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.31.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.31 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.31 — leitor Excel robusto com fallback direto
...
## V5.31 — correção de `parseSharedBytes is not defined`
...
## V5.31 — suporte a XML com namespace/prefixo
...
A V5.31 reconhece os dois formatos.
...
## V5.31 — cálculo do peso por pedido e alocação por capacidade
...
## V5.31 — leite puro somente manual
...
## V5.31 — roteirização porta a porta por embarque
...
## V5.31 — rotas de entrega por motorista na Análise inteligente
...
## V5.31 — perto para longe + App do Motorista
...
## V5.31 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.31 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.31 — um único App com todas as entregas do motorista
...
- links V5.31 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.31 — GPS do motorista + monitoramento em tempo real
...
## V5.31 — Firebase já integrado ao software
...
## Correção V5.31 — link do App do Motorista
...
## V5.31 — traçado da rota no mapa do motorista
