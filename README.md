...
## V5.44 — embarque automático por rota
...
## V5.44 — dashboard com detalhamento por dia, cidade e pedido
...
## V5.44 — análise inteligente de rotas
...
As recomendações são apenas sugestões. A V5.44 **não move pedidos automaticamente** entre embarques.
...
## V5.44 — mapa semanal e antecipação de rotas futuras
...
## V5.44 — leite, derivados e filtros de alocação

A V5.44 classifica cada pedido pelos itens que existem dentro dele.
...
## V5.44 — regras selecionáveis de alocação
...
## V5.44 — recálculo automático ao mudar as regras
...
## V5.44 — mapeamento automático de colunas
...
## V5.44 — identificação de planilha otimizada
...
## V5.44 — correção do travamento em “Identificando estrutura”
...
## V5.44 — correção do erro `unzip is not defined`

Foi removida a função `parseWorkbook()` antiga que permaneceu duplicada na V5.44.

Ela sobrescrevia o leitor novo e tentava executar `unzip()`, função que já havia sido substituída pelo leitor seguro.

A V5.44 mantém somente o leitor novo baseado em:
- `buildZipIndex`;
- `extractZipEntry`;
- `DecompressionStream`;
...
## V5.44 — leitor Excel robusto com fallback direto
...
## V5.44 — correção de `parseSharedBytes is not defined`
...
## V5.44 — suporte a XML com namespace/prefixo
...
A V5.44 reconhece os dois formatos.
...
## V5.44 — cálculo do peso por pedido e alocação por capacidade
...
## V5.44 — leite puro somente manual
...
## V5.44 — roteirização porta a porta por embarque
...
## V5.44 — rotas de entrega por motorista na Análise inteligente
...
## V5.44 — perto para longe + App do Motorista
...
## V5.44 — Apps dos Motoristas vinculados ao Gestão Logística
...
## V5.44 — WhatsApp funciona também com o sistema aberto localmente
...
## V5.44 — um único App com todas as entregas do motorista
...
- links V5.44 com múltiplas rotas (`v:2`);
- links antigos com uma rota (`v:1`), convertidos automaticamente.

## V5.44 — GPS do motorista + monitoramento em tempo real
...
## V5.44 — Firebase já integrado ao software
...
## Correção V5.44 — link do App do Motorista
...
## V5.44 — traçado da rota no mapa do motorista
...
`V5.44 — traçado rodoviário`

## V5.44 — PWA instalável, GPS obrigatório e mapa estável
...
## V5.44 — canhoto obrigatório e WhatsApp
...
## V5.44 — correção do travamento do canhoto
...
A V5.44 inclui novamente toda a PWA:
- manifest.webmanifest
- sw.js
- icons/
- canhoto.html
...
## V5.44 — finalização das rotas e canhotos na central
...
## V5.44 — rotas pendentes e concluídas separadas
...
## V5.44 — gerar somente rotas pendentes + exceções do motorista
...
## V5.44 — ESPD fonte mestre + reentregas
...
## V5.44 — roteirização de teste com coordenadas fixas

Para eliminar falhas de geocodificação durante testes, a V5.44 reconhece duas novas colunas opcionais:
...
## V5.44 — descarga na frente do estabelecimento / otimização por rua
...
## V5.44 — Embarques e Central de Rotas reorganizados
...
## V5.44 — correção da linha azul no App do Motorista
...
## V5.44 — Central de Rotas compacta
...
## V5.44 — acompanhamento movido para Embarques
