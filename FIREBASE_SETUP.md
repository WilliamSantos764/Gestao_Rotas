# Firebase já integrado na V5.34

A configuração Web do projeto Firebase já está gravada no Gestão Logística V5.34.
...
3. `index.html` e `motorista.html` V5.34 publicados no mesmo diretório HTTPS.
...
## V5.34 — Firebase Storage para canhotos
...
Publique a pasta completa da V5.34 no GitHub Pages.
